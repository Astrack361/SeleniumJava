...
public class LoginTests {
	...
	public void NegativeLoginTest(String username, String password, String expectedErrorMessage) {
		...
		// log in button is visible WebElement logOutButton =
		WebElement logInButtonVerification = driver.findElement(By.xpath("//i[@class='fa fa-2x fa-sign-in']"));
		Assert.assertTrue(logInButtonVerification.isDisplayed(), "Log In button is not visible");
